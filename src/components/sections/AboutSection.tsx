...
export default function AboutSection() {
  ...
  const generateFact = () => {
    const facts = [
      "Industrial Engineering was first taught in 1908 at Penn State University.",
      "Lillian Gilbreth, an early industrial engineer, is considered the mother of modern management.",
      "The first industrial engineering department was established in 1908.",
      "Industrial engineers work to eliminate waste of time, money, materials, and energy.",
      "Ergonomics is a key sub-discipline of modern industrial engineering.",
    ];
